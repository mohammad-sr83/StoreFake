...
import CardBestSeller from "./BestSeller/CardBestSeller";
  ...
  return (
    ...
    >
      <div className="w-full flex justify-center items-center relative">
        ...
        <h2 className="text-xl flex justify-center items-center"><Flame className="text-yellow-500" /> داغ ترین محصولات</h2>
      </div>
